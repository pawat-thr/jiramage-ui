...
export default function TeamPage({
  ...
  const visible = useMemo(
    () => filterIssues(issues, { hideDone, status, name: nameFilter, search, type }),
    [issues, hideDone, status, nameFilter, search, type],
  )
  ...
  return (
    <>
      <div className={toolbar}>
        ...
        />
        <FilterMenu label="Member" value={nameFilter} options={nameOptions} onPick={onNameFilter} />
